...
import com.CaseStudy.AdminSecurity.model.TicketReservation;
import com.CaseStudy.AdminSecurity.model.Trains;
import com.CaseStudy.AdminSecurity.model.AdminModel;
import com.CaseStudy.AdminSecurity.repository.AdminRepository;
import com.CaseStudy.AdminSecurity.services.AdminService;
...
//reservation operations
	...
	private ResponseEntity<?> subscribeClient(@RequestBody AuthenticationRequest authenticationRequest)
	{
		...
		return ResponseEntity.ok(new AuthenticationResponse("Succesfull sign-in as admin: "+username));
	}
